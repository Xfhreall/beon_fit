...
class DashboardController extends Controller
{
    public function __invoke(): JsonResponse
    {
        ...
        $monthlyIncome = Payment::where('period_year', $year)->where('period_month', $month)->sum('amount');
        $monthlyExpense = Expense::whereYear('spent_at', $year)->whereMonth('spent_at', $month)->sum('amount');
