    ...
    return (
        <>
            ...
            <div className="grid gap-4 p-4">
                <Card>
                    ...
                    <CardContent className="grid gap-2 text-sm md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <div>
                                <StatusBadge value={resident.resident_status} />
                            </div>
                        </div>
                        <div>
                            <span className="text-muted-foreground">
                            ...
                            <div>
                                {resident.marital_status.replace('_', ' ')}
                            </div>
                        </div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>Riwayat rumah</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
                            ...
                            <TableBody>
                                {resident.occupancies.length === 0 ? (
                                    ...
                                    resident.occupancies.map((occupancy) => (
                                        <TableRow key={occupancy.id}>
                                            <TableCell>
                                                {occupancy.house.number}
                                            </TableCell>
                                            <TableCell>
                                                {occupancy.started_at}
                                            </TableCell>
                                            <TableCell>
                                                {occupancy.ended_at ?? '-'}
                                            </TableCell>
                                            <TableCell>
                                                {occupancy.resident_status}
                                            </TableCell>
                                        </TableRow>
                                    ))
                                )}
